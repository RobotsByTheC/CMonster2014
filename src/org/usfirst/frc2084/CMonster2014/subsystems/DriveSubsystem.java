...
public class DriveSubsystem extends Subsystem {
    ...
    SpeedController frontLeftTalon = RobotMap.driveSubsystemFrontLeftTalon;
    SpeedController frontLeftTalon2 = RobotMap.driveSubsystemFrontLeftTalon2;
    SpeedController frontRightTalon = RobotMap.driveSubsystemFrontRightTalon;
    SpeedController frontRightTalon2 = RobotMap.driveSubsystemFrontRightTalon2;
    SpeedController rearLeftTalon = RobotMap.driveSubsystemRearLeftTalon;
    SpeedController rearLeftTalon2 = RobotMap.driveSubsystemRearLeftTalon2;
    SpeedController rearRightTalon = RobotMap.driveSubsystemRearRightTalon;
    SpeedController rearRightTalon2 = RobotMap.driveSubsystemRearRightTalon2;
    ...
    private final WheelController frontLeftWheel = new WheelController(frontLeftTalon, frontLeftTalon2);
    private final WheelController frontRightWheel = new WheelController(frontRightTalon, frontRightTalon2);
    private final WheelController rearLeftWheel = new WheelController(rearLeftTalon, rearLeftTalon2);
    private final WheelController rearRightWheel = new WheelController(rearRightTalon, rearRightTalon2);
